    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=500, verbose_name='Title')),
                ('slug', models.CharField(help_text='Leave blank to have the URL auto-generated from the title.', max_length=2000, null=True, verbose_name='URL', blank=True)),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, editable=False, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, blank=True, to='mezzanine_blocks.BlockCategory', null=True)),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, editable=False, to='sites.Site')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='block',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, blank=True, to='mezzanine_blocks.BlockCategory', null=True),
        ),
        migrations.AddField(
            model_name='block',
            name='site',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, editable=False, to='sites.Site'),
        ),
    ]
